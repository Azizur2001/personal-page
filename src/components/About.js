    ...
    >
      ...
      >
        ...
        <Grow in={imageInView} timeout={1000}>
          <div>
            {" "}
            {/* Wrapping in a div to ensure valid child for Grow */}
            <Box
              sx={{
                position: "relative",
        ...
        <Fade in={textInView} timeout={1500}>
          <div>
            {" "}
            {/* Wrapping in a div to ensure valid child for Fade */}
            <Box
              sx={{
                maxWidth: "600px",
                ml: { xs: 0, md: 5 },
            ...
            >
              ...
              >
                I’m a tech enthusiast who loves building and customizing things.
                Outside of tech, I enjoy playing soccer, watching TV shows and
                anime, going out, and being in positive environments. I always
                keep an open mind, so feel free to reach out!
              </Typography>
              ...
              >
                ...
                <Button
                  ...
                  sx={{
                    ...
                    fontWeight: "bold",
                    "&:hover": {
                      backgroundColor: "rgba(255, 0, 0, 0.1)", // Red hover background
                      borderColor: "#e53935",
                    },
                  }}
                  href="#contact"
