...
//                     sx={{ color: '#fff', position: 'absolute', top: 15, right: 15 }}
//                   >
//                     <Close />
//                   </IconButton>
...
//             <div>
//               {navLinks.map((link, index) => (
//                 <Link key={index} to={link.to} smooth={true} duration={500} offset={-70}>
//                   <Button sx={{ color: 'white', fontWeight: 'bold' }}>{link.label}</Button>
//                 </Link>
//               ))}
//             </div>
//           )}
            ...
            <>
              ...
              <Drawer anchor="right" open={drawerOpen} onClose={toggleDrawer(false)}>
                ...
                >
                  ...
                  <ListItem button>
                    <a href="https://github.com/your-github-username" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                      <ListItemText
                        primary="Github"
                        sx={{
                          color: 'white',
